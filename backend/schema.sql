...
CREATE TABLE `Faculty` (
  ...
  `created_at`        TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `updated_at`        TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  CONSTRAINT `fk_faculty_dept` FOREIGN KEY (`department_id`) REFERENCES `Department`(`department_id`)
    ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE VIEW `vw_faculty_directory` AS
  SELECT
    f.`faculty_id`, f.`name`, f.`employee_no`, f.`email`, f.`phone`,
    f.`designation`, f.`qualification`, f.`specialization`, f.`office_location`,
    f.`gender`, f.`joining_date`, f.`is_registered`,
    d.`department_name`, lm.`member_id`, lm.`status` AS `membership_status`
  FROM `Faculty` f
...
INSERT INTO `Department` (`department_name`) VALUES
  ('Computer Science'), ('Mathematics'), ('English Literature'), ('Physics'), ('Business Administration');

INSERT INTO `Publishers` (`publisher_name`) VALUES
  ('MIT Press'), ('O\'Reilly Media'), ('Pearson Education'), ('Cambridge University Press'),
  ('McGraw-Hill'), ('Addison-Wesley'), ('No Starch Press'), ('Manning Publications');

INSERT INTO `Categories` (`category_name`) VALUES
  ('Computer Science'), ('Mathematics'), ('Fiction'), ('Science'), ('Engineering'),
  ('History'), ('Database'), ('Networking'), ('Operating Systems'), ('Software Engineering');

INSERT INTO `Authors` (`author_name`) VALUES
  ('Thomas H. Cormen'), ('Charles E. Leiserson'), ('Ronald L. Rivest'), ('Clifford Stein'),
  ('Robert C. Martin'), ('Martin Fowler'), ('Andrew S. Tanenbaum'), ('Abraham Silberschatz'),
  ('Henry F. Korth'), ('S. Sudarshan'), ('James Kurose'), ('Keith Ross'), ('Brian W. Kernighan'),
  ('Dennis M. Ritchie'), ('Donald E. Knuth'), ('Erich Gamma'), ('Richard Helm'), ('Ralph Johnson'),
  ('John Vlissides'), ('Bjarne Stroustrup');
...
INSERT INTO `Students`
  (`name`, `registration_no`, `email`, `phone`, `department_id`, `date_of_birth`, `enrollment_date`, `academic_year`, `gender`, `is_registered`) VALUES
  ('Ali Hassan',     'CS-2021-001', 'ali.hassan@uni.edu',    '0300-1234567', 1, '2001-03-15', '2021-09-01', '3rd Year', 'male',   0),
  ('Sara Khan',      'CS-2021-002', 'sara.khan@uni.edu',     '0301-2345678', 1, '2001-07-22', '2021-09-01', '3rd Year', 'female', 0),
  ('Ahmed Raza',     'MT-2020-001', 'ahmed.raza@uni.edu',    '0302-3456789', 2, '2000-11-10', '2020-09-01', '4th Year', 'male',   0),
  ('Fatima Malik',   'EL-2022-001', 'fatima.malik@uni.edu',  '0303-4567890', 3, '2002-05-30', '2022-09-01', '2nd Year', 'female', 0),
  ('Usman Tariq',    'PH-2021-003', 'usman.tariq@uni.edu',    '0304-5678901', 4, '2001-01-18', '2021-09-01', '3rd Year', 'male',   0);

INSERT INTO `Faculty`
  (`name`, `employee_no`, `email`, `phone`, `department_id`, `designation`, `is_registered`) VALUES
  ('Dr. Irfan Malik',   'FAC-001', 'irfan.malik@uni.edu',   '0311-1111111', 1, 'Associate Professor', 0),
  ('Prof. Nadia Shah',  'FAC-002', 'nadia.shah@uni.edu',    '0312-2222222', 2, 'Professor',           0),
  ('Dr. Kamran Baig',   'FAC-003', 'kamran.baig@uni.edu',   '0313-3333333', 5, 'Assistant Professor', 0);
...
INSERT INTO `Book_Authors` (`book_id`, `author_id`, `author_order`) VALUES
  ...
  (5, 8, 1),
  (6, 13, 1), (6, 14, 2),
  (7, 16, 1), (7, 17, 2), (7, 18, 3), (7, 19, 4),
  (8, 15, 1),
  (9, 6, 1),
  (10, 20, 1);

INSERT INTO `Book_Copies` (`book_id`, `barcode`, `shelf_location`, `status`) VALUES
  (1, 'CS-001-A', 'A1-01', 'available'), (1, 'CS-001-B', 'A1-01', 'available'),
  (2, 'CS-002-A', 'A1-02', 'available'), (2, 'CS-002-B', 'A1-02', 'available'), (2, 'CS-002-C', 'A1-02', 'available'),
  (3, 'NW-003-A', 'B2-01', 'available'), (3, 'NW-003-B', 'B2-01', 'available'),
  (4, 'DB-004-A', 'B3-01', 'available'), (4, 'DB-004-B', 'B3-01', 'available'),
  (5, 'OS-005-A', 'C1-01', 'available'), (5, 'OS-005-B', 'C1-01', 'available'),
  (6, 'CS-006-A', 'A1-03', 'available'),
  (7, 'CS-007-A', 'A2-01', 'available'), (7, 'CS-007-B', 'A2-01', 'available'),
  (8, 'CS-008-A', 'A2-02', 'available'),
  (9, 'SE-009-A', 'D1-01', 'available'), (9, 'SE-009-B', 'D1-01', 'available'),
  (10, 'CS-010-A', 'A1-04', 'available'), (10, 'CS-010-B', 'A1-04', 'available');